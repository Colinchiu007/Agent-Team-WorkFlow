# update-project003-registry.ps1
# 精确替换 PROJECT-REGISTRY.md 中的 PROJECT-003 章节

$ErrorActionPreference = "Stop"

$registryPath = "C:\Users\邱领\.qclaw\workspace\team\PROJECT-REGISTRY.md"
...
# 使用正则表达式替换（匹配从 ### PROJECT-003 到下一个 ### 之前）
$pattern = '(?s)(### PROJECT-003：.*?)(?=\n###|\n##)'
...
Write-Output "✅ 已更新 PROJECT-REGISTRY.md（PROJECT-003 章节）"
